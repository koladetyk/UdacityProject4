...
contract('FlightSuretyData', (accounts) => {
    ...
    it('ensures payouts are made correctly, considering gas costs', async () => {
        ...
        assert(creditedAmount.gt(new web3.utils.BN(0)), "Insuree should be credited before payout");
        ...
        assert(finalBalance.gt(initialBalance), "Payout not processed correctly or no funds were credited.");
    });
